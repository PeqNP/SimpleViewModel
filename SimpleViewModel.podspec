#
#  Be sure to run `pod spec lint SimpleViewModel.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SimpleViewModel"
  spec.version      = "1.5.2"
  spec.summary      = "Provides framework to create robust view models in Swift."
  ...
  A non-opinionated, robust, testable view model signaling pattern for Swift.
                   DESC
  ...
  # spec.social_media_url   = "https://twitter.com/bitheadRL"
